...
pacman::p_load(usethis,pacman,rio,ggplot2,ggthemes,quantmod,dplyr,data.table,lubridate,forecast,gifski,av,tidyr,gganimate,zoo,RCurl,Cairo,datetime,stringr,pollster,tidyquant,hrbrthemes,plotly,fredr,gcookbook,tidyverse)
library(hrbrthemes)
...
geom_line(data=df2, aes(x=Date, y = Value, color = "Konsumgüter")) +
